...
echo "<td valign=\"top\" class=\"dark\"><b>User Name</b></td>\n";
...
echo "<td valign=\"top\" class=\"dark\"><b>Last Comment At</b></td><td valign=\"top\" class=\"light\"><b></b></td>\n";
echo "</tr>\n";
...
while($userlist = $database->fetch_array($query))
{
	...
	echo "<tr align=\"center\" width=\"100%\">\n";
	echo "<td valign=\"top\" class=\"dark\"><b>".$userName."</b></td><td valign=\"top\" class=\"light\">".$ranking."</td>\n";
	echo "<td valign=\"top\" class=\"dark\"><b>".$postCount."</b></td><td valign=\"top\" class=\"light\">".$post."</td>\n";
	echo "<td valign=\"top\" class=\"dark\"><b>".$commentCount."</b></td><td valign=\"top\" class=\"light\">".$comment."</td>\n";
	echo "</tr>\n";
}
