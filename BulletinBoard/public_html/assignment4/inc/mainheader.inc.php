...
<div align="right"><a href="<? echo $path; ?>index.php"><img src="styles/default.gif" class="logo" width = "80%" ></a></div><BR>
...
if(isset($_SESSION['uid']))
{
	...
	echo " | <a href=\"".$path."userdetails/index.php\">User Details</a>";
	echo " | <a href=\"".$path."notefy.php\">Notify</a>";
	echo " | <a href=\"rss.php\" target=\"_blank\">RSS Syndication Feed</a> ";
	
	if($_SESSION['admin'] == 1 || $_SESSION['mod'] == 1)
	{
		echo " | <a href=\"".$path."admin/index.php\">Control Panel</a>";
	} 
	if($_SESSION['mod'] == 1 || $_SESSION['mod'] != 1)
	{
...
echo " | <a href=\"".$path."search.php\">Search</a>";
echo " | <a href=\"".$path."contactus.php\">Contact Us</a>";
 

  
 if(isset($_SESSION['uid']))
 {
	//echo " | <a href=\"".$path."users/userdetails.php\">Show Users</a>";
