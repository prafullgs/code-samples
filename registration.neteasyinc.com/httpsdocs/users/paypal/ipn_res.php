...
// paypal email
$paypal_email = "prafull.shirodkar@neteasyinc.com";

// email address where script should send notifications
$error_email = "prafull.shirodkar@neteasyinc.com";
...
switch( $paypal_ipn->get_payment_status() )
{
	...
	case 'Completed':
		...
		if ($paypal_ipn->paypal_post_vars['txn_type']=="reversal") {
			...
			/*	$qry="INSERT INTO paypal_table VALUES ('', '$payer_id', '$payment_date', '$txn_id', '$first_name', '$last_name', '$payer_email', '$payer_status', '$payment_type', '$memo', '$item_name', '$item_number', $quantity, $mc_gross, '$mc_currency', '$address_name', '".nl2br($address_street)."', '$address_city', '$address_state', '$address_zip', '$address_country', '$address_status', '$payer_business_name', '$payment_status', '$pending_reason', '$reason_code', '$txn_type')";*/
				$timestamp = date("Y-m-d H:i:s"); 
				$qry="INSERT INTO paypaltest VALUES('','Transaction Successful','$timestamp')";
