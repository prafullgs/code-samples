...
<head>
	...
	<title>Widget 6</title>
	<link rel="stylesheet" href="/css/reset.css" type="text/css">
	<link rel="stylesheet" href="/css/widget6.css" type="text/css">
</head>
		...
		<div class="content">
			<div class="content-inner">
				...
				<div class="channel-one">
					<span class="label"><?php echo $data['channel_one_type']; ?></span>
					<span class="value"><?php echo $data['channel_one_value']; ?></span>
					<span class="type"><?php echo $data['channel_one_unit']; ?></span>
				</div>
				<div class="channel-two">
					<span class="label"><?php echo $data['channel_two_type']; ?></span>
					<span class="value"><?php echo $data['channel_two_value']; ?></span>
					<span class="type"><?php echo $data['channel_two_unit']; ?></span>
				</div>
				</div>
    		...
    		<div class="content">
    			<div class="content-inner">
                        ...
                        if((isset($_GET['channel_one_value'])) && (trim($_GET['channel_one_value']) != ""))
                         {
                             if(ereg("([0-9]+)",$_GET['channel_one_value']) && ($_GET['channel_one_value'] < 999)){
                                ...
                                echo $data['channel_one_value'];
                             }
                            else
                            {
                               echo '<script type="text/javascript">window.alert("Only Numbers < 999 are allowed for Channel One Value")</script>';
    				...
    				<div class="channel-two">
                        ...
                        if((isset($_GET['channel_two_value'])) && (trim($_GET['channel_two_value']) != ""))
                        {
                             if(ereg("([0-9]+)",$_GET['channel_two_value']) && ($_GET['channel_two_value'] < 999)){
                                ...
                                echo $data['channel_two_value'];
                            }
                            else
                            {
                               echo '<script type="text/javascript">window.alert("Only Numbers < 999 are allowed for Channel Two Value")</script>';
    				...
    				<div class="target">
    					...
    					<div class="target-channel">
    						<span class="target-channel-label"><?php echo $data['target_one_type'];?>:</span>
    						<span class="target-channel-value"><?php if((isset($_GET['target_one_value'])) && (trim($_GET['target_one_value']) != ""))
                             {
    					...
    					<div class="target-channel">
    						<span class="target-channel-label"><?php echo $data['target_two_type'];?>:</span>
    						<span class="target-channel-value"><?php if((isset($_GET['target_two_value'])) && (trim($_GET['target_two_value']) != ""))
                             {
