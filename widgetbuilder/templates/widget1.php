...
<head>
	...
	<link rel="stylesheet" href="/css/widget1.css" type="text/css">
</head>
    	...
    	<div id="container">
    		...
    		<div class="content">
    			<div class="content-inner">
    				...
    				<?php if ($data['target']): ?>
    					<div class="widget-target">Target:&nbsp;<strong><?php echo $data['target']; ?></strong>&nbsp;<?php echo $data['units']; ?></div>
    				<?php endif;?>
    		</div>
    	...
    	<div id="container">
    		...
    		<div class="content">
    			<div class="content-inner">
    				...
    				<?php if ($data['target']): ?>
    					<div class="widget-target">Target:&nbsp;<strong><?php  
                        ...
                        ?></strong>&nbsp;<?php echo $data['units']; ?></div>
    				<?php endif;?>
    		</div>
    		<?php if ($data['button_text']): ?>
